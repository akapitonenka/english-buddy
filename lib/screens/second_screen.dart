...
class _SecondScreenState extends State<SecondScreen> {
  ...
  void initState() {
    ...
    shuffle(list);
    list1 = List.generate(widget.dictionaryWord.translation.length, (index) => LetterModel(letter: null, index: null));
    super.initState();
  }
                    ...
                    children: [
                      Expanded(
                        child: Wrap(
                          ...
                          children: list1.asMap().entries.map((e) =>
                            WordTile(
                              text: e.value.letter,
                              onClick: () {
                                setState(() {
                                  ...
                                  list1[e.key] =  LetterModel(letter: null, index: null);
                                });
                              },
                            )
                          ).toList(),
                    ...
                    children: list.asMap().entries.map((e) =>
                      Tile(
                        ...
                        onClick: () {
                          setState(() {
                            list[e.key] = null;
                            list1[activeIndex] = LetterModel(letter: e.value, index: e.key);
                            activeIndex++;
                          });
                        },
                      )
